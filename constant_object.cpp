...
int main(){
    Fraction f(10, 20);
    f.Print();
    Fraction const f1(29, 30);
    // cout<<f1.getDenominator()<< " "<<f1.getNumerator()<<endl;  // we can not access them form here directly beacuse out object is 
    // constant so compiler wants that no custom fucntion can edit constnt class functionality
    //here we can call only constant function
